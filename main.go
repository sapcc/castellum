...
func runAPI(ctx context.Context, cfg core.Config, dbi *sql.DB, team core.AssetManagerTeam, providerClient core.ProviderClient, httpListenAddr string) {
...
func runObserver(ctx context.Context, cfg core.Config, dbi *sql.DB, team core.AssetManagerTeam, providerClient core.ProviderClient, httpListenAddr string) {
...
func runWorker(ctx context.Context, dbi *sql.DB, team core.AssetManagerTeam, httpListenAddr string) {
