INSERT INTO assets (id, resource_id, uuid, size, usage_percent, scraped_at, stale) VALUES (1, 1, 'asset1', 1000, 40, 99991, FALSE);
INSERT INTO assets (id, resource_id, uuid, size, usage_percent, scraped_at, stale) VALUES (2, 1, 'asset2', 2000, 50, 99991, FALSE);
INSERT INTO assets (id, resource_id, uuid, size, usage_percent, scraped_at, stale) VALUES (3, 3, 'asset5', 5000, 50, 99992, FALSE);
INSERT INTO assets (id, resource_id, uuid, size, usage_percent, scraped_at, stale) VALUES (4, 3, 'asset6', 6000, 42, 99992, FALSE);
